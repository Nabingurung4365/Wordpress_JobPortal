...
class WL_JP_Setting {
	public static function add_settings_link( $links ) {
	    $settings_link = '<a href="' . menu_page_url( 'job_portal_settings', false ) . '">' . esc_html__( 'Settings', WL_JP_DOMAIN ) . '</a>';
	...
	public static function register_settings() {
		...
		add_settings_section( $settings_section_general, esc_html__( 'General', WL_JP_DOMAIN ), '', $page );

		/* Add fields to section */
		add_settings_field( 'wljp_general_jobs_per_page', esc_html__( 'Number of jobs per page', WL_JP_DOMAIN ), array( 'WL_JP_Setting', 'wljp_general_jobs_per_page_input' ), $page, $settings_section_general );

		add_settings_field( 'wljp_general_admin_applications_per_page', esc_html__( 'Number of applications per page in admin panel', WL_JP_DOMAIN ), array( 'WL_JP_Setting', 'wljp_general_admin_applications_per_page_input' ), $page, $settings_section_general );

		add_settings_field( 'wljp_general_candidate_jobs_applied_per_page', esc_html__( 'Number of jobs applied per page in candidate panel', WL_JP_DOMAIN ), array( 'WL_JP_Setting', 'wljp_general_candidate_jobs_applied_per_page_input' ), $page, $settings_section_general );

		add_settings_field( 'wljp_general_job_portal_page_id', esc_html__( 'Job Portal Page', WL_JP_DOMAIN ) . '<br><span id="wljp_job_portal_shortcode">[job_portal]</span> <span id="wljp_job_portal_shortcode_copy">' . esc_html__( 'Copy', WL_JP_DOMAIN ) . '</span>', array( 'WL_JP_Setting', 'wljp_general_job_portal_page_id_input' ), $page, $settings_section_general );

		add_settings_field( 'wljp_general_account_page_id', esc_html__( 'Account Page', WL_JP_DOMAIN ) . '<br><span id="wljp_job_portal_account_shortcode">[job_portal_account]</span> <span id="wljp_job_portal_account_shortcode_copy">' . esc_html__( 'Copy', WL_JP_DOMAIN ) . '</span>', array( 'WL_JP_Setting', 'wljp_general_account_page_id_input' ), $page, $settings_section_general );
	}
	...
	public static function wljp_general_candidate_jobs_applied_per_page_input() {
		$general_candidate_jobs_applied_per_page = WL_JP_Helper::general_candidate_jobs_applied_per_page();
		echo '<input type="number" min="0" step="1" id="wljp_general_candidate_jobs_applied_per_page" name="wljp_general[candidate_jobs_applied_per_page]" value="' . $general_candidate_jobs_applied_per_page . '">';
	}
