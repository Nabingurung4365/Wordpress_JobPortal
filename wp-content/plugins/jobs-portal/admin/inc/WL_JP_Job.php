...
class WL_JP_Job {
	...
	public static function add_meta_boxes() {
	    add_meta_box( 'wljp_job_work_experience', __( 'Work Experience', WL_JP_DOMAIN ), array( 'WL_JP_Job', 'work_experience_html' ), 'job', 'side' );
	    add_meta_box( 'wljp_job_salary', __( 'Salary', WL_JP_DOMAIN ), array( 'WL_JP_Job', 'job_salary_html' ), 'job', 'advanced' );
	}
	...
	?>
		...
		<div class="wljp" id="wljp_job_work_experience">
			<div class="mb-2">
				<label for="wljp_job_work_experience_minimum"><?php _e( 'Minimum Years', WL_JP_DOMAIN ); ?>:</label>
				<input type="number" name="job_work_experience_minimum" id="wljp_job_work_experience_minimum" class="widefat required" value="<?php echo $minimum; ?>">
			</div>

			<div class="mt-2">
				<label for="wljp_job_work_experience_maximum"><?php _e( 'Maximum Years', WL_JP_DOMAIN ); ?>:</label>
				<input type="number" name="job_work_experience_maximum" id="wljp_job_work_experience_maximum" class="widefat required" value="<?php echo $maximum; ?>">
			</div>
		</div>
	<?php
	}
	...
	?>
		<div class="wljp" id="wljp_job_salary">
			<div class="form-check form-check-inline">
				...
				<label class="form-check-label" for="wljp-job-salary-unspecified"><?php _e( 'Unspecified', WL_JP_DOMAIN ); ?></label>
			</div>
			<div class="form-check form-check-inline">
				...
				<label class="form-check-label" for="wljp-job-salary-negotiable"><?php _e( 'Negotiable', WL_JP_DOMAIN ); ?></label>
			</div>
			<div class="form-check form-check-inline">
				...
				<label class="form-check-label" for="wljp-job-salary-fixed"><?php _e( 'Fixed', WL_JP_DOMAIN ); ?></label>
			</div>
			<div class="form-check form-check-inline">
				...
				<label class="form-check-label" for="wljp-job-salary-range"><?php _e( 'Range', WL_JP_DOMAIN ); ?></label>
			</div>

			<div class="wljp_job_salary">
				<div class="row mt-2">
					<div class="col-md-4 col-sm-6">
						<label for="wljp_job_salary_minimum"><?php _e( 'Minimum Salary', WL_JP_DOMAIN ); ?>:</label>
						<input type="text" name="wljp_job_salary_minimum" id="wljp_job_salary_minimum" class="widefat" <?php if ( $is_range ) { echo "value='{$minimum}'"; } ?>>
					</div>  
					<div class="col-md-4 col-sm-6">
						<label for="wljp_job_salary_maximum"><?php _e( 'Maximum Salary', WL_JP_DOMAIN ); ?>:</label>
